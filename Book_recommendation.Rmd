...
# ---------------------
setwd("D:/Ph.D_materials/Programming/R_programming/mdsr/Book_recommend")
```
...
```{r}
# Sample data
recommended_book <- c("ISBN.0060929596", "ISBN.0373834985", "ISBN.038533656X", "ISBN.0440217520", "ISBN.0679450548", "ISBN.0743230213", "ISBN.0802135196")

read_book <- "ISBN.0743230213"

# Initialize an empty vector to store assigned recommended books
assigned_books <- c( )

# Iterate over each recommended book
for (book in recommended_book) {
  # Check if the recommended book matches the read book
  if (book == read_book) {
    # Add the recommended book to the assigned books vector
    assigned_books <- c(assigned_books, book)
  }
}

# Print the assigned recommended books
